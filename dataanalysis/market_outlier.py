...
# Step 7: Outlier Analysis by Market
outliers_by_market = {}
...
for market, outliers in outliers_by_market.items():
    print(f"\n--- Outliers for Market: {market} ---")
    print("Time Taken Outliers:\n", outliers["time_outliers"].head())
    print("Frequency Outliers:\n", outliers["freq_outliers"].head())
