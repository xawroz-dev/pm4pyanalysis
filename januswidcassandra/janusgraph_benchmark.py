...
def run_benchmark():
    ...
    try:
        ...
        print(f"  Events:          {validation.get('total_events', 'N/A'):,}")
        print(f"  Journeys:        {validation.get('total_journeys', 'N/A'):,}")
        print(f"  Orphaned Events: {validation.get('orphaned_events', 'N/A'):,}")
